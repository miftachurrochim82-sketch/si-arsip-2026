...
// ============================================================
// Bridge tipis ke CoreLib v2.4.0 (pin 17) + kontrak dispatcher v2.
...
// ─────────────────────────────────────────────────────────────
// ROLE_LEVELS — salinan identik MASTER_ROLE_LEVELS CoreLib v2.4.0.
...
// ==================== §1d WORKFLOW & PERIODE ====================
var STATUS_MAP = {
  'T_SURAT_MASUK': { 'baru': ['diproses','arsip'], 'diproses': ['selesai','tertunda'], 'tertunda': ['diproses','arsip'], 'selesai': ['arsip'], 'arsip': [] },
  'T_SURAT_KELUAR': { 'baru': ['dikirim','arsip'], 'dikirim': ['selesai','arsip'], 'selesai': ['arsip'], 'arsip': [] },
  'T_TINDAK_LANJUT': { 'baru': ['proses','batal'], 'proses': ['selesai','tertunda'], 'tertunda': ['proses','batal'], 'selesai': [], 'batal': [] }
};
...
function getAppConfig_() {
  return {
    ...
    resources: {
      'T_SURAT_MASUK': { ownerField: 'pegawai_id' },
      'T_SURAT_KELUAR': { ownerField: 'pegawai_id' },
